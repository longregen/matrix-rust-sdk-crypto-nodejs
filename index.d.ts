...
export interface ImportRoomKeysResult {
...
export interface CrossSigningKeyExportResult {
...
export declare class UserIdentity {
  ...
  get wasPreviouslyVerified(): boolean
  /** Does this identity have a verification violation. */
  get hasVerificationViolation(): boolean
...
export declare class OlmMachine {
   ...
   *   response returned.
   */
  receiveSyncChanges(toDeviceEvents: string, changedDevices: DeviceLists, oneTimeKeyCounts: Record<string, number>, unusedFallbackKeys: Array<string>): Promise<ReceiveSyncChangesResult>
  /**
   ...
   */
  importExportedRoomKeys(exportedKeysJson: string): Promise<ImportRoomKeysResult>
   ...
   */
  isRoomKeyAvailable(event: string, roomId: RoomId): Promise<boolean>
  /**
   ...
   * * `room_id`, the room ID where the event was sent.
   */
  requestRoomKey(event: string, roomId: RoomId): Promise<Array<KeysUploadRequest | KeysQueryRequest | KeysClaimRequest | ToDeviceRequest | SignatureUploadRequest | RoomMessageRequest>>
  /**
   ...
   */
  discardRoomKey(roomId: RoomId): Promise<boolean>
  /**
   ...
   */
  getSasVerification(userId: UserId, flowId: string): Sas | null
  /** Get a verification request for the given user and flow ID. */
  getVerificationRequest(userId: UserId, flowId: string): VerificationRequest | null
  /** Get all verification requests for the given user. */
  getVerificationRequests(userId: UserId): Array<VerificationRequest>
  /**
   ...
   */
  receiveVerificationEvent(event: string): Promise<void>
  /** Get a device by its user ID and device ID. */
  getDevice(userId: UserId, deviceId: DeviceId): Promise<Device | null>
  /** Get all devices for a user. */
  getUserDevices(userId: UserId): Promise<Array<Device>>
  /** Get the user identity for the given user ID. */
  getIdentity(userId: UserId): Promise<UserIdentity | null>
  /**
   * Export the private cross-signing keys.
   *
   * Returns `null` if no cross-signing keys are available.
   */
  exportCrossSigningKeys(): Promise<CrossSigningKeyExportResult | null>
  /** Import private cross-signing keys. */
  importCrossSigningKeys(masterKey?: string | undefined | null, selfSigningKey?: string | undefined | null, userSigningKey?: string | undefined | null): Promise<CrossSigningStatus>
  /**
   ...
   */
  queryKeysForUsers(users: Array<UserId>): KeysQueryRequest
...
export declare class Sas {
   ...
   */
  accept(): ToDeviceRequest | RoomMessageRequest | null
  /**
   ...
   */
  confirm(): Promise<Array<KeysUploadRequest | KeysQueryRequest | KeysClaimRequest | ToDeviceRequest | SignatureUploadRequest | RoomMessageRequest>>
  /** Cancel the verification. */
  cancel(): ToDeviceRequest | RoomMessageRequest | null
...
export declare class VerificationRequest {
   ...
   */
  startSas(): Promise<ToDeviceRequest | RoomMessageRequest | null>
